define([ 'dat', 'container' ], function(dat, container) {
  ...
  gui.gui = new dat.GUI({ autoPlace: true });
  ...
  gui.guiData = {
    ...
    remoteStatus: remoteHost ? false : true,
    remoteHost: remoteHost || url.hostname,
    remotePort: remotePort || url.hash.substr(1),
    remoteFrequency: 10,
  };
